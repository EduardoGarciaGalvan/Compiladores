...
bool Compiler::ErrorsModule::addErrors(ERROR_PHASE phase, int lineNumber, String ^ errorDesc, String ^ errorLine)
{
...
cli::array<String^>^ Compiler::ErrorsModule::getErrors()
{
